  ...
  useEffect(() => {
    ...
    const checkIsAvailable = async () => {
      if (soulname) {
        ...
        setIsAvailable(
          await masa.contracts.soulName.isAvailable(soulname)
        );
     ...
     const masa = new Masa({
      ...
      if  (isLoggedIn && isAvailable) {
        ...
        if(checkId.identityId) {
          ...
          const createSoulNames = await masa.soulName.create('CELO', soulname, duration, undefined, 'style')
          ...
          const createWithId = await masa.identity.createWithSoulName('CELO', soulname, duration, 'style')
  ...
  >
    ...
    >
      <chakra.span
        ...
        mb={6}
      >
        <chakra.span display="block">Wanna embrace the power of soulnames and web3 identity?</chakra.span>
        <chakra.span
          display="block"
          color="brand.600"
          _dark={{
      ...
      <Stack
        ...
        mt={2}
      >
        <Box display="inline-flex" rounded="md" shadow="md" onClick={onOpen}>
          <Link
            w="full"
            display="inline-flex"
            alignItems="center"
...
<Modal blockScrollOnMount={false} isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalBody>
            ...
            {isAvailable ? (<Text mt={2} color={'green.500'}>Available</Text>): (<Text mt={2} color={'red.400'}>Not Available</Text>)}

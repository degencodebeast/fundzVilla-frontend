...
contract CampaignManager is Ownable {
    ...
    function getParticularCampaignId(Campaign campaign) public view returns (uint256 _campaignId){
    ...
    function verifyCampaign(uint256 _campaignId) public onlyOwner {
        require(!isCampaignVerified[_campaignId], "This campaign is already verified");
